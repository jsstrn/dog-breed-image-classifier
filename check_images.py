...
def main():
    ...
    stats = calculates_results_stats(pet_labels)

    # Function that checks Results Statistics Dictionary using results_stats
    check_calculating_results(pet_labels, stats)
    ...
    print_results(pet_labels, stats, model, True, True)
